...
// PortB
#define KEYPIN_SHIFT    PA3
#define KEYPIN_F4       PD3
#define KEYPIN_F3       PB4
#define KEYPIN_F2       PB5
#define KEYPIN_F1       PB6
#define KEYPIN_F0       PB7
...
// PortA
#define ANA_SPD         PA0
#define DIRSWITCH       PA1
#define LED_GREEN_R     PA2
#define LED_GREEN_L     PA3
#define LED_RED         PA4
#define ANA_VERSION     PA5
...
// PortD Pd fehlen bei at8 Hier nochmal <----------------------------------------------------------------------------
#define ENC_BIT_0       PD2
#define ENC_BIT_1       PD3
#define ENC_SWITCH      PB1
