...
void vProcessKey(void)
{
	...
	//Funktionstasten-L
	    ...
	    if( (PINA & (1<<PA2)) ) { //Funktionstaste-L-1
		    //Loconet
		    } 

	    if( (PINB & (1<<PB4)) ) { //Funktionstaste-L-2
		    //Loconet
	    }
		
	    if( (PINB & (1<<PB0)) ) { //Funktionstaste-L-3
		    //Loconet
	    }

	    if( (PINC & (1<<PC2)) ) { //Funktionstaste-L-4
		    //Loconet
	    }
		

	//Funktionstasten
	    if( (PIND & (1<<PD6)) ) { //Funktionstaste-1
		    //Loconet
	    }

	    if( (PIND & (1<<PD5)) ) { //Funktionstaste-2
		    //Loconet
	    }

	    if( (PIND & (1<<PD4)) ) { //Funktionstaste-3
		    //Loconet
	    }

	    if( (PIND & (1<<PD3)) ) { //Funktionstaste-4
		    //Loconet
	    }
}
